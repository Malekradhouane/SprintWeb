...
namespace Proxies\__CG__\KarhabtyBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Users extends \KarhabtyBundle\Entity\Users implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'KarhabtyBundle\\Entity\\Users' . "\0" . 'nom', '' . "\0" . 'KarhabtyBundle\\Entity\\Users' . "\0" . 'prenom', '' . "\0" . 'KarhabtyBundle\\Entity\\Users' . "\0" . 'cin', '' . "\0" . 'KarhabtyBundle\\Entity\\Users' . "\0" . 'mail', '' . "\0" . 'KarhabtyBundle\\Entity\\Users' . "\0" . 'telephone', '' . "\0" . 'KarhabtyBundle\\Entity\\Users' . "\0" . 'adresse', '' . "\0" . 'KarhabtyBundle\\Entity\\Users' . "\0" . 'piécePermission', '' . "\0" . 'KarhabtyBundle\\Entity\\Users' . "\0" . 'path', '' . "\0" . 'KarhabtyBundle\\Entity\\Users' . "\0" . 'role', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function getpiécePermission()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getpiécePermission', []);

        return parent::getpiécePermission();
    }
    ...
    public function setpiécePermission($piécePermission)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setpiécePermission', [$piécePermission]);

        return parent::setpiécePermission($piécePermission);
    }
