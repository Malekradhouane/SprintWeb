...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \KarhabtyBundle\Form\RegistrationType A KarhabtyBundle\Form\RegistrationType instance
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \KarhabtyBundle\Form\RegistrationType();
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('+Jys2Hohm+', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wbOb3-quo6', 0, 'boL1NJepCpTKWg6wnaBhiP', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ivRqj+Qm10', 0, 'boL1NJepCpTKWg6wnaBhiP', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('L+TlJfQJQt', 0, 'boL1NJepCpTKWg6wnaBhiP', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'sql9.freemysqlhosting.net', 'port' => 3306, 'dbname' => 'sql9206738', 'user' => 'sql9206738', 'password' => 'EXNr3Vc7pp', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $d, $f, array('enum' => 'string'));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\TemplateBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\KarhabtyBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'TemplateBundle\\Entity');
        $c->addDriver($b, 'KarhabtyBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('TemplateBundle' => 'TemplateBundle\\Entity', 'KarhabtyBundle' => 'KarhabtyBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4d6e51b18d4372afa9d2fb1d869a5fce4a2c4c58248d0f3d3af50f07d5188719');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('KarhabtyBundle\\Entity\\Users');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('aaa' => 'aaa'), 'resetting' => array('aaa' => 'aaa'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('KarhabtyBundle\\Entity\\Users');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'KarhabtyBundle\\Form\\RegistrationType', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('KarhabtyBundle\\Entity\\Users');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('KarhabtyBundle\\Entity\\Users');
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('fos_user.util.password_updater'), $this->get('fos_user.util.canonical_fields_updater'), $this->get('doctrine')->getManager(NULL), 'KarhabtyBundle\\Entity\\Users');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \TemplateBundle\Entity\AfterLoginRedirection A TemplateBundle\Entity\AfterLoginRedirection instance
     */
    protected function getRedirect_After_LoginService()
    {
        return $this->services['redirect.after.login'] = new \TemplateBundle\Entity\AfterLoginRedirection($this->get('router'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\KarhabtyBundle/Resources/views'), 'Karhabty');
        $instance->addPath(($this->targetDirs[3].'\\src\\KarhabtyBundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\VoitureBundle/Resources/views'), 'Voiture');
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\AutoEcoleBundle/Resources/views'), 'AutoEcole');
    ...
    /**
     * Gets the 'vich_uploader.namer_origname.product_images' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Vich\UploaderBundle\Naming\OrignameNamer A Vich\UploaderBundle\Naming\OrignameNamer instance
     */
    protected function getVichUploader_NamerOrigname_ProductImagesService()
    {
        return $this->services['vich_uploader.namer_origname.product_images'] = new \Vich\UploaderBundle\Naming\OrignameNamer();
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN'), 'ROLE_CLIENT' => array(0 => 'ROLE_USER')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'KarhabtyBundle' => 'KarhabtyBundle\\KarhabtyBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'VoitureBundle' => 'VoitureBundle\\VoitureBundle',
                ...
                'AutoEcoleBundle' => 'AutoEcoleBundle\\AutoEcoleBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'KarhabtyBundle' => array(
                    'parent' => 'FOSUserBundle',
                    'path' => ($this->targetDirs[3].'\\src\\KarhabtyBundle'),
                ...
                'VoitureBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\VoitureBundle'),
                    'namespace' => 'VoitureBundle',
                ),
                ...
                'AutoEcoleBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\AutoEcoleBundle'),
                    'namespace' => 'AutoEcoleBundle',
                ),
                ...
                'KnpSnappyBundle' => array(
                    'parent' => NULL,
                    'path' => 'C:/wamp64/www/SprintWeb/vendor/knplabs/knp-snappy-bundle',
            ...
            'database_port' => 3306,
            'database_name' => 'sql9206738',
            'database_user' => 'sql9206738',
            'database_password' => 'EXNr3Vc7pp',
            ...
            'locale' => 'en',
            'app.path.product_images' => 'web/images/Oussama',
            ...
            'fos_user.model.user.class' => 'KarhabtyBundle\\Entity\\Users',
            ...
            'fos_user.registration.form.type' => 'KarhabtyBundle\\Form\\RegistrationType',
            ...
            'vich_uploader.mappings' => array(
                'product_images' => array(
                    'uri_prefix' => 'web/images/Oussama',
                    'upload_destination' => ($this->targetDirs[3].'\\app/../web/images/Oussama'),
                    'namer' => array(
            ...
            'knp_paginator.template.sortable' => '@KnpPaginator/Pagination/twitter_bootstrap_v3_pagination.html.twig',
